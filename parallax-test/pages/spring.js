  ...
  return (
    ...
    >
      <g>
        <g>
          <path
            d="M549.813,513.458c-2.718-1.673-5.598-3.174-8.568-4.325c-6.287-2.436-10.607-6.87-12.183-13.211
...
export default function Spring() {
  ...
  return (
    <div>
      <Parallax pages={5}>
        <ParallaxLayer offset={0} style={{ backgroundColor: "grey" }}>
          <h2>Welcome to the parallax.</h2>
        </ParallaxLayer>
        <ParallaxLayer></ParallaxLayer>
        <ParallaxLayer offset={0} speed={0} style={{ opacity: "20%" }}>
          <Image src={trees} width={"50%"} />
        </ParallaxLayer>
        <ParallaxLayer offset={0} speed={0.05} style={{ opacity: "1" }}>
          <Image src={trees} width={"50%"} style={{ marginLeft: "150px" }} />
        </ParallaxLayer>
        <ParallaxLayer
          style={{
